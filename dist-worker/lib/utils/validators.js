...
exports.isValidRepositoryIdentifier = isValidRepositoryIdentifier;
/**
 ...
 */
function isValidRepositoryIdentifier(identifier) {
    if (!identifier || typeof identifier !== "string")
        return false;
    if (identifier.length > 150 || identifier.length < 3)
        return false;
