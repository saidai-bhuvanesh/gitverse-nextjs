...
exports.SecurityPRService = void 0;
const githubService_1 = require("@/lib/services/githubService");
const cve_scanner_1 = require("./cve-scanner");
const dependency_migrator_1 = require("./dependency-migrator");
const validation_runner_1 = require("./validation-runner");
class SecurityPRService {
    scanner = new cve_scanner_1.CVEScannerService();
    migrator = new dependency_migrator_1.DependencyMigratorService();
    validator = new validation_runner_1.ValidationRunnerService();
    /**
     * Run the full zero-day auto-patching pipeline on a repository.
     */
    async runPipeline(owner, repo, repoPath, githubToken) {
    ...
    async createSecurityPR(github, owner, repo, scanResult, plan, validation) {
...
exports.SecurityPRService = SecurityPRService;
